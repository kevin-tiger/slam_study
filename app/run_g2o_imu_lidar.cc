...
string bag_path = "/workspace_18_04/slam_in_autonomous_driving/dataset/sad/nclt/20120429.bag";
string config_file = "./config/velodyne_nclt.yaml";
...
int main(int argc, char** argv)
{
    ...
    RosbagIO rosbag_io(bag_path, DatasetType::NCLT);
