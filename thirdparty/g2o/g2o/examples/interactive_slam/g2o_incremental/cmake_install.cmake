# Install script for directory: /workspace_18_04/slam_study/thirdparty/g2o/g2o/examples/interactive_slam/g2o_incremental
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/workspace_18_04/slam_study/thirdparty/g2o/lib/libg2o_incremental.so")
  if(EXISTS "$ENV{DESTDIR}/usr/local/lib/libg2o_incremental.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libg2o_incremental.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/lib/libg2o_incremental.so"
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/workspace_18_04/slam_study/thirdparty/g2o/bin/g2o_incremental")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/g2o_incremental" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/g2o_incremental")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/g2o_incremental"
...
file(INSTALL DESTINATION "/usr/local/include/g2o/examples/interactive_slam/g2o_incremental" TYPE FILE FILES
    "/workspace_18_04/slam_study/thirdparty/g2o/g2o/examples/interactive_slam/g2o_incremental/g2o_incremental_api.h"
    "/workspace_18_04/slam_study/thirdparty/g2o/g2o/examples/interactive_slam/g2o_incremental/graph_optimizer_sparse_incremental.h"
    "/workspace_18_04/slam_study/thirdparty/g2o/g2o/examples/interactive_slam/g2o_incremental/linear_solver_cholmod_online.h"
    )
endif()
